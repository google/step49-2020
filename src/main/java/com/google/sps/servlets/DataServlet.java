...
public class DataServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    // should be null
    if (protoGraph == null || protoNodesMap == null || graph == null || graphNodesMap == null || roots == null) {
  ...
  public String graphToJson(MutableGraph<GraphNode> graph, HashSet<String> roots) {
    ...
    String bothJson = new JSONObject().put("nodes", nodeJson).put("edges", edgeJson).put("roots", rootsJson).toString();
    return bothJson;
  }
