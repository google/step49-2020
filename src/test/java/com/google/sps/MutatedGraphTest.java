...
public class MaxDepthTest {
  ...
  public void oneStepMutation() {
    ...
    DataGraph mutatedGraph = Utility.getGraphAtMutationNumber(dataGraph, 0, 1, mutList);
  ...
  public void twoStepForwardMutation() {
    ...
    DataGraph mutatedGraph = Utility.getGraphAtMutationNumber(dataGraph, 0, 2, mutList);
